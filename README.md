...
<head>
    <meta charset="UTF-8">
    <title> mlabdpforlsjhew : Test de l'algorithme Google et SEO </title>
    <meta name="description" content="Le mot mlabdpforlsjhew est un terme inventé dans le cadre d’un cours pour tester l’algorithme de Google, l’indexation des pages web et l’efficacité du référencement naturel (SEO).">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="canonical" href="https://ngut3826.github.io/">
...
<body>
    <header>
        <h1>mlabdpforlsjhew : Mot Test pour l'algorithme Google et le Référencement SEO </h1>
    ...
    <main>
        ...
        <section>
            ...
            <ul class="changelog">
                ...
                <li><strong>2026-02-12</strong> : Modification de la Meta description et du titre afin d'avoir un titre plus fort et une description plus longue. Ajout d'un lien canonical </li>
            </ul>
        </section>
    </main>
